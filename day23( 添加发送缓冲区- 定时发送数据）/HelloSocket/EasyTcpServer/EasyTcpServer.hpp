...
//网络消息发送任务
class CellSenMsg2ClientTask : public CellTask
{
	ClientSocket* _pClient;
	DataHeader* _pHeader;
public:
	CellSenMsg2ClientTask(ClientSocket* pClient, DataHeader* header)
	{
		_pClient = pClient;
		_pHeader = header;
	}
...
public:
	...
	{
		CellSenMsg2ClientTask* task = new CellSenMsg2ClientTask(pClient, header);
